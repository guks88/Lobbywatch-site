(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('vega-dataflow'), require('vega-util'), require('d3-format'), require('vega-scale'), require('d3-array'), require('d3-interpolate')) :
  typeof define === 'function' && define.amd ? define(['exports', 'vega-dataflow', 'vega-util', 'd3-format', 'vega-scale', 'd3-array', 'd3-interpolate'], factory) :
  (factory((global.vega = global.vega || {}),global.vega,global.vega,global.d3,global.vega,global.d3,global.d3));
}(this, (function (exports,vegaDataflow,vegaUtil,d3Format,vegaScale,d3Array,d3Interpolate) { 'use strict';
...
prototype.transform = function(_, pulse) {
  ...
  var out = pulse.fork(pulse.NO_SOURCE | pulse.NO_FIELDS),
      ...
      values = _.values || tickValues(scale$$1, count);
...
prototype$2.transform = function(_, pulse) {
  var out = pulse.fork(pulse.ADD_REM),
      ...
      update = _.encoders.update || vegaUtil.falsy,
      enter = _.encoders.enter || vegaUtil.falsy,
      exit = _.encoders.exit || vegaUtil.falsy,
      set = (encode && !reenter ? _.encoders[encode] : update) || vegaUtil.falsy;
...
function configureDomain(scale$$1, _, df) {
  ...
  if (_.nice && scale$$1.nice) scale$$1.nice((_.nice !== true && +_.nice) || null);
...
function rawDomain(scale$$1, raw) {
  return raw ? (scale$$1.domain(raw), raw.length) : -1;
}
...
var prototype$7 = vegaUtil.inherits(Stack, vegaDataflow.Transform);
...
vegaDataflow.register(LinkPathDefinition, LinkPath);
vegaDataflow.register(PieDefinition, Pie);
vegaDataflow.register(StackDefinition, Stack);

vegaDataflow.transform('AxisTicks', AxisTicks);
vegaDataflow.transform('DataJoin', DataJoin);
vegaDataflow.transform('Encode', Encode);
vegaDataflow.transform('LegendEntries', LegendEntries);
vegaDataflow.transform('Scale', Scale);

exports.transform = vegaDataflow.transform;
exports.definition = vegaDataflow.definition;
exports.scale = vegaScale.scale;
exports.scheme = vegaScale.scheme;
